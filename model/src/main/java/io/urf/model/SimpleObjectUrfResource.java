...
/**
 * An URF resource wrapping an object, with no description.
...
public class SimpleObjectUrfResource<T> extends BaseUrfResource implements ObjectUrfResource<T> {
	 ...
	 */
	public SimpleObjectUrfResource(@Nullable final URI tag, @Nonnull final T object) {
	 ...
	 */
	public SimpleObjectUrfResource(@Nullable final URI tag, @Nullable final String typeHandle, @Nonnull final T object) {
	 ...
	 * @throws IllegalArgumentException if a tag is given that is not an absolute IRI.
	 */
	public SimpleObjectUrfResource(@Nullable final URI tag, @Nullable final URI typeTag, @Nonnull final T object) {
		super(tag, typeTag);
